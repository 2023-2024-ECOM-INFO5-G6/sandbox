  ...
  return (
    <div>
      <h2 id="rappel-heading" data-cy="RappelHeading">
        <Translate contentKey="blogApp.rappel.home.title">Rappels</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blogApp.rappel.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/rappel/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogApp.rappel.home.createLabel">Create new Rappel</Translate>
          </Link>
        </div>
      </h2>
        ...
        {rappelList && rappelList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="blogApp.rappel.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.rappel.dateDebut">Date Debut</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.rappel.dateFin">Date Fin</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.rappel.frequence">Frequence</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.rappel.description">Description</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.rappel.patient">Patient</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.rappel.utilisateur">Utilisateur</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blogApp.rappel.home.notFound">No Rappels found</Translate>
            </div>
          )
        )}
      </div>
