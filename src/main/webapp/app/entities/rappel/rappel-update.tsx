  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blogApp.rappel.home.createOrEditLabel" data-cy="RappelCreateUpdateHeading">
            <Translate contentKey="blogApp.rappel.home.createOrEditLabel">Create or edit a Rappel</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('blogApp.rappel.dateDebut')}
                id="rappel-dateDebut"
                name="dateDebut"
                data-cy="dateDebut"
                type="date"
              ...
              />
              <ValidatedField
                label={translate('blogApp.rappel.dateFin')}
                id="rappel-dateFin"
                name="dateFin"
                data-cy="dateFin"
                type="date"
              />
              <ValidatedField
                label={translate('blogApp.rappel.frequence')}
                id="rappel-frequence"
                name="frequence"
                data-cy="frequence"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('blogApp.rappel.description')}
              ...
              <ValidatedField
                ...
                name="utilisateur"
                data-cy="utilisateur"
                label={translate('blogApp.rappel.utilisateur')}
                type="select"
                required
              >
                <option value="" key="0" />
