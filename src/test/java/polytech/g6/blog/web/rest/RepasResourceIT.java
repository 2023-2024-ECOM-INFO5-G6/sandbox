...
class RepasResourceIT {
    ...
    private static final Long DEFAULT_ID_R = 1L;
    private static final Long UPDATED_ID_R = 2L;
    ...
    void createRepas() throws Exception {
        ...
        assertThat(testRepas.getIdR()).isEqualTo(DEFAULT_ID_R);
    ...
    @Test
    @Transactional
    void checkIdRIsRequired() throws Exception {
    ...
    void getAllRepas() throws Exception {
        ...
        restRepasMockMvc
            ...
            .andExpect(jsonPath("$.[*].idR").value(hasItem(DEFAULT_ID_R.intValue())))
    ...
    void getRepas() throws Exception {
        ...
        restRepasMockMvc
            ...
            .andExpect(jsonPath("$.idR").value(DEFAULT_ID_R.intValue()))
    ...
    void putExistingRepas() throws Exception {
        ...
        updatedRepas.idR(UPDATED_ID_R).dateR(UPDATED_DATE_R).heureR(UPDATED_HEURE_R).epa(UPDATED_EPA);
        ...
        Repas testRepas = repasList.get(repasList.size() - 1);
        assertThat(testRepas.getIdR()).isEqualTo(UPDATED_ID_R);
    ...
    void fullUpdateRepasWithPatch() throws Exception {
        ...
        partialUpdatedRepas.idR(UPDATED_ID_R).dateR(UPDATED_DATE_R).heureR(UPDATED_HEURE_R).epa(UPDATED_EPA);
