  ...
  return (
    <div>
      <h2 id="repas-heading" data-cy="RepasHeading">
        <Translate contentKey="blogApp.repas.home.title">Repas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blogApp.repas.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/repas/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogApp.repas.home.createLabel">Create new Repas</Translate>
          </Link>
        </div>
      </h2>
        ...
        {repasList && repasList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="blogApp.repas.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.repas.idR">Id R</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.repas.dateR">Date R</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.repas.heureR">Heure R</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.repas.epa">Epa</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.repas.patient">Patient</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blogApp.repas.home.notFound">No Repas found</Translate>
            </div>
          )
        )}
      </div>
