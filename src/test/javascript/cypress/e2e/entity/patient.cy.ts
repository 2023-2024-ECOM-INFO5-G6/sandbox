...
describe('Patient e2e test', () => {
  ...
  describe('new Patient page', () => {
    ...
    it.skip('should create an instance of Patient', () => {
      ...
      cy.get(`[data-cy="dateNaissanceP"]`).type('2023-11-11').blur().should('have.value', '2023-11-11');

      cy.get(`[data-cy="tailleP"]`).type('34440').should('have.value', '34440');

      cy.get(`[data-cy="sexeP"]`).select('HOMME');
