...
describe('Mesure e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/patients',
      body: {"idP":14889,"nomP":"logistical","prenomP":"niches uniform","dateNaissanceP":"2023-11-12","tailleP":40833,"sexeP":"AUTRE","dateArrivee":"2023-11-12"},
    }).then(({ body }) => {
      patient = body;
    });
  });
  ...
  describe('new Mesure page', () => {
    ...
    it.skip('should create an instance of Mesure', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-11-12').blur().should('have.value', '2023-11-12');
