  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blogApp.etablissement.home.createOrEditLabel" data-cy="EtablissementCreateUpdateHeading">
            <Translate contentKey="blogApp.etablissement.home.createOrEditLabel">Create or edit a Etablissement</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('blogApp.etablissement.idE')}
              ...
              />
              <ValidatedField
                label={translate('blogApp.etablissement.nomE')}
              ...
              />
              <ValidatedField
                label={translate('blogApp.etablissement.adresseE')}
