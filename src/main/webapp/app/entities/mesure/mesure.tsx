  ...
  return (
    <div>
      <h2 id="mesure-heading" data-cy="MesureHeading">
        <Translate contentKey="blogApp.mesure.home.title">Mesures</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blogApp.mesure.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/mesure/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogApp.mesure.home.createLabel">Create new Mesure</Translate>
          </Link>
        </div>
      </h2>
        ...
        {mesureList && mesureList.length > 0 ? (
            ...
            <tbody>
              {mesureList.map((mesure, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`blogApp.TypeMesure.${mesure.type}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blogApp.mesure.home.notFound">No Mesures found</Translate>
            </div>
          )
        )}
      </div>
