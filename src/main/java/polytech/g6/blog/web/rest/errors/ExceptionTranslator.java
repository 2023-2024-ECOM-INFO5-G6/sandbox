...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof polytech.g6.blog.service.EmailAlreadyUsedException ||
            ex instanceof polytech.g6.blog.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof polytech.g6.blog.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "polytech.g6.blog");
    }
}
