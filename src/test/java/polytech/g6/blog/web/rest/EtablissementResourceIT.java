...
class EtablissementResourceIT {
    ...
    public static Etablissement createEntity(EntityManager em) {
        Etablissement etablissement = new Etablissement().idE(DEFAULT_ID_E).nomE(DEFAULT_NOM_E).adresseE(DEFAULT_ADRESSE_E);
        // Add required entity
        Chambre chambre;
    ...
    public static Etablissement createUpdatedEntity(EntityManager em) {
        Etablissement etablissement = new Etablissement().idE(UPDATED_ID_E).nomE(UPDATED_NOM_E).adresseE(UPDATED_ADRESSE_E);
        // Add required entity
        Chambre chambre;
        if (TestUtil.findAll(em, Chambre.class).isEmpty()) {
    ...
    void putExistingEtablissement() throws Exception {
        ...
        updatedEtablissement.idE(UPDATED_ID_E).nomE(UPDATED_NOM_E).adresseE(UPDATED_ADRESSE_E);
    ...
    void fullUpdateEtablissementWithPatch() throws Exception {
        ...
        partialUpdatedEtablissement.idE(UPDATED_ID_E).nomE(UPDATED_NOM_E).adresseE(UPDATED_ADRESSE_E);
