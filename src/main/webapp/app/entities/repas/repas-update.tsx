  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blogApp.repas.home.createOrEditLabel" data-cy="RepasCreateUpdateHeading">
            <Translate contentKey="blogApp.repas.home.createOrEditLabel">Create or edit a Repas</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('blogApp.repas.idR')}
                id="repas-idR"
                name="idR"
                data-cy="idR"
                type="text"
              ...
              />
              <ValidatedField label={translate('blogApp.repas.dateR')} id="repas-dateR" name="dateR" data-cy="dateR" type="date" />
              <ValidatedField
                label={translate('blogApp.repas.heureR')}
                id="repas-heureR"
                name="heureR"
                data-cy="heureR"
                type="datetime-local"
