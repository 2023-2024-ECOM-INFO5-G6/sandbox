  ...
  return (
    <div>
      <h2 id="etablissement-heading" data-cy="EtablissementHeading">
        <Translate contentKey="blogApp.etablissement.home.title">Etablissements</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blogApp.etablissement.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/etablissement/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogApp.etablissement.home.createLabel">Create new Etablissement</Translate>
          </Link>
        </div>
      </h2>
        ...
        {etablissementList && etablissementList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="blogApp.etablissement.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blogApp.etablissement.home.notFound">No Etablissements found</Translate>
            </div>
          )
        )}
      </div>
