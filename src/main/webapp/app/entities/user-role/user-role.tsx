  ...
  return (
    <div>
      <h2 id="user-role-heading" data-cy="UserRoleHeading">
        <Translate contentKey="blogApp.userRole.home.title">User Roles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blogApp.userRole.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/user-role/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogApp.userRole.home.createLabel">Create new User Role</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userRoleList && userRoleList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="blogApp.userRole.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.userRole.role">Role</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {userRoleList.map((userRole, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`blogApp.Role.${userRole.role}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blogApp.userRole.home.notFound">No User Roles found</Translate>
            </div>
          )
        )}
      </div>
