  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blogApp.userRole.home.createOrEditLabel" data-cy="UserRoleCreateUpdateHeading">
            <Translate contentKey="blogApp.userRole.home.createOrEditLabel">Create or edit a UserRole</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('blogApp.userRole.role')} id="user-role-role" name="role" data-cy="role" type="select">
                {roleValues.map(role => (
                  <option value={role} key={role}>
                    {translate('blogApp.Role.' + role)}
                  </option>
                ))}
              </ValidatedField>
