  ...
  return (
    <div>
      <h2 id="chambre-heading" data-cy="ChambreHeading">
        <Translate contentKey="blogApp.chambre.home.title">Chambres</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blogApp.chambre.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/chambre/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogApp.chambre.home.createLabel">Create new Chambre</Translate>
          </Link>
        </div>
      </h2>
        ...
        {chambreList && chambreList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="blogApp.chambre.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.chambre.numC">Num C</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blogApp.chambre.home.notFound">No Chambres found</Translate>
            </div>
          )
        )}
      </div>
